...
public class OrderControllerTest {
    ...
    public void createOrder_success() throws Exception {
        ...
        purchaseItem1.setProductId(1);
        purchaseItem1.setQuantity(5);
        purchaseItemList.add(purchaseItem1);

        PurchaseItem purchaseItem2 = new PurchaseItem();
        purchaseItem2.setProductId(2);
        purchaseItem2.setQuantity(2);
        purchaseItemList.add(purchaseItem2);

        createOrderRequest.setPurchaseItemList(purchaseItemList);
    ...
    @Transactional
    @Test
    public void createOrder_illegalArgument_emptyPurchaseItemList() throws Exception {
        CreateOrderRequest createOrderRequest = new CreateOrderRequest();
        List<PurchaseItem> purchaseItemList = new ArrayList<>();
        createOrderRequest.setPurchaseItemList(purchaseItemList);
